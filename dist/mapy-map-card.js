"use strict";(()=>{var Or=Object.create;var Ve=Object.defineProperty;var xo=Object.getOwnPropertyDescriptor;var Ir=Object.getOwnPropertyNames;var Zr=Object.getPrototypeOf,Br=Object.prototype.hasOwnProperty;var q=(u,r)=>()=>(u&&(r=u(u=0)),r);var $r=(u,r)=>()=>(r||u((r={exports:{}}).exports,r),r.exports),Rr=(u,r)=>{for(var a in r)Ve(u,a,{get:r[a],enumerable:!0})},Nr=(u,r,a,h)=>{if(r&&typeof r=="object"||typeof r=="function")for(let c of Ir(r))!Br.call(u,c)&&c!==a&&Ve(u,c,{get:()=>r[c],enumerable:!(h=xo(r,c))||h.enumerable});return u};var Dr=(u,r,a)=>(a=u!=null?Or(Zr(u)):{},Nr(r||!u||!u.__esModule?Ve(a,"default",{value:u,enumerable:!0}):a,u));var ft=(u,r,a,h)=>{for(var c=h>1?void 0:h?xo(r,a):r,_=u.length-1,p;_>=0;_--)(p=u[_])&&(c=(h?p(r,a,c):p(c))||c);return h&&c&&Ve(r,a,c),c};var je,Ke,Lo,wo,Ge,Po,To,Di,Hi=q(()=>{/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */je=globalThis,Ke=je.ShadowRoot&&(je.ShadyCSS===void 0||je.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Lo=Symbol(),wo=new WeakMap,Ge=class{constructor(r,a,h){if(this._$cssResult$=!0,h!==Lo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=r,this.t=a}get styleSheet(){let r=this.o,a=this.t;if(Ke&&r===void 0){let h=a!==void 0&&a.length===1;h&&(r=wo.get(a)),r===void 0&&((this.o=r=new CSSStyleSheet).replaceSync(this.cssText),h&&wo.set(a,r))}return r}toString(){return this.cssText}},Po=u=>new Ge(typeof u=="string"?u:u+"",void 0,Lo),To=(u,r)=>{if(Ke)u.adoptedStyleSheets=r.map(a=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of r){let h=document.createElement("style"),c=je.litNonce;c!==void 0&&h.setAttribute("nonce",c),h.textContent=a.cssText,u.appendChild(h)}},Di=Ke?u=>u:u=>u instanceof CSSStyleSheet?(r=>{let a="";for(let h of r.cssRules)a+=h.cssText;return Po(a)})(u):u});var Hr,Fr,Wr,Ur,qr,Vr,Tt,So,jr,Gr,me,ge,Ye,ko,xt,ve=q(()=>{Hi();Hi();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */({is:Hr,defineProperty:Fr,getOwnPropertyDescriptor:Wr,getOwnPropertyNames:Ur,getOwnPropertySymbols:qr,getPrototypeOf:Vr}=Object),Tt=globalThis,So=Tt.trustedTypes,jr=So?So.emptyScript:"",Gr=Tt.reactiveElementPolyfillSupport,me=(u,r)=>u,ge={toAttribute(u,r){switch(r){case Boolean:u=u?jr:null;break;case Object:case Array:u=u==null?u:JSON.stringify(u)}return u},fromAttribute(u,r){let a=u;switch(r){case Boolean:a=u!==null;break;case Number:a=u===null?null:Number(u);break;case Object:case Array:try{a=JSON.parse(u)}catch{a=null}}return a}},Ye=(u,r)=>!Hr(u,r),ko={attribute:!0,type:String,converter:ge,reflect:!1,useDefault:!1,hasChanged:Ye};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),Tt.litPropertyMetadata??(Tt.litPropertyMetadata=new WeakMap);xt=class extends HTMLElement{static addInitializer(r){this._$Ei(),(this.l??(this.l=[])).push(r)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(r,a=ko){if(a.state&&(a.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(r)&&((a=Object.create(a)).wrapped=!0),this.elementProperties.set(r,a),!a.noAccessor){let h=Symbol(),c=this.getPropertyDescriptor(r,h,a);c!==void 0&&Fr(this.prototype,r,c)}}static getPropertyDescriptor(r,a,h){let{get:c,set:_}=Wr(this.prototype,r)??{get(){return this[a]},set(p){this[a]=p}};return{get:c,set(p){let v=c?.call(this);_?.call(this,p),this.requestUpdate(r,v,h)},configurable:!0,enumerable:!0}}static getPropertyOptions(r){return this.elementProperties.get(r)??ko}static _$Ei(){if(this.hasOwnProperty(me("elementProperties")))return;let r=Vr(this);r.finalize(),r.l!==void 0&&(this.l=[...r.l]),this.elementProperties=new Map(r.elementProperties)}static finalize(){if(this.hasOwnProperty(me("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(me("properties"))){let a=this.properties,h=[...Ur(a),...qr(a)];for(let c of h)this.createProperty(c,a[c])}let r=this[Symbol.metadata];if(r!==null){let a=litPropertyMetadata.get(r);if(a!==void 0)for(let[h,c]of a)this.elementProperties.set(h,c)}this._$Eh=new Map;for(let[a,h]of this.elementProperties){let c=this._$Eu(a,h);c!==void 0&&this._$Eh.set(c,a)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(r){let a=[];if(Array.isArray(r)){let h=new Set(r.flat(1/0).reverse());for(let c of h)a.unshift(Di(c))}else r!==void 0&&a.push(Di(r));return a}static _$Eu(r,a){let h=a.attribute;return h===!1?void 0:typeof h=="string"?h:typeof r=="string"?r.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(r=>r(this))}addController(r){(this._$EO??(this._$EO=new Set)).add(r),this.renderRoot!==void 0&&this.isConnected&&r.hostConnected?.()}removeController(r){this._$EO?.delete(r)}_$E_(){let r=new Map,a=this.constructor.elementProperties;for(let h of a.keys())this.hasOwnProperty(h)&&(r.set(h,this[h]),delete this[h]);r.size>0&&(this._$Ep=r)}createRenderRoot(){let r=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return To(r,this.constructor.elementStyles),r}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(r=>r.hostConnected?.())}enableUpdating(r){}disconnectedCallback(){this._$EO?.forEach(r=>r.hostDisconnected?.())}attributeChangedCallback(r,a,h){this._$AK(r,h)}_$ET(r,a){let h=this.constructor.elementProperties.get(r),c=this.constructor._$Eu(r,h);if(c!==void 0&&h.reflect===!0){let _=(h.converter?.toAttribute!==void 0?h.converter:ge).toAttribute(a,h.type);this._$Em=r,_==null?this.removeAttribute(c):this.setAttribute(c,_),this._$Em=null}}_$AK(r,a){let h=this.constructor,c=h._$Eh.get(r);if(c!==void 0&&this._$Em!==c){let _=h.getPropertyOptions(c),p=typeof _.converter=="function"?{fromAttribute:_.converter}:_.converter?.fromAttribute!==void 0?_.converter:ge;this._$Em=c;let v=p.fromAttribute(a,_.type);this[c]=v??this._$Ej?.get(c)??v,this._$Em=null}}requestUpdate(r,a,h,c=!1,_){if(r!==void 0){let p=this.constructor;if(c===!1&&(_=this[r]),h??(h=p.getPropertyOptions(r)),!((h.hasChanged??Ye)(_,a)||h.useDefault&&h.reflect&&_===this._$Ej?.get(r)&&!this.hasAttribute(p._$Eu(r,h))))return;this.C(r,a,h)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(r,a,{useDefault:h,reflect:c,wrapped:_},p){h&&!(this._$Ej??(this._$Ej=new Map)).has(r)&&(this._$Ej.set(r,p??a??this[r]),_!==!0||p!==void 0)||(this._$AL.has(r)||(this.hasUpdated||h||(a=void 0),this._$AL.set(r,a)),c===!0&&this._$Em!==r&&(this._$Eq??(this._$Eq=new Set)).add(r))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(a){Promise.reject(a)}let r=this.scheduleUpdate();return r!=null&&await r,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[c,_]of this._$Ep)this[c]=_;this._$Ep=void 0}let h=this.constructor.elementProperties;if(h.size>0)for(let[c,_]of h){let{wrapped:p}=_,v=this[c];p!==!0||this._$AL.has(c)||v===void 0||this.C(c,void 0,_,v)}}let r=!1,a=this._$AL;try{r=this.shouldUpdate(a),r?(this.willUpdate(a),this._$EO?.forEach(h=>h.hostUpdate?.()),this.update(a)):this._$EM()}catch(h){throw r=!1,this._$EM(),h}r&&this._$AE(a)}willUpdate(r){}_$AE(r){this._$EO?.forEach(a=>a.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(r)),this.updated(r)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(r){return!0}update(r){this._$Eq&&(this._$Eq=this._$Eq.forEach(a=>this._$ET(a,this[a]))),this._$EM()}updated(r){}firstUpdated(r){}};xt.elementStyles=[],xt.shadowRootOptions={mode:"open"},xt[me("elementProperties")]=new Map,xt[me("finalized")]=new Map,Gr?.({ReactiveElement:xt}),(Tt.reactiveElementVersions??(Tt.reactiveElementVersions=[])).push("2.1.2")});function Ro(u,r){if(!Gi(u)||!u.hasOwnProperty("raw"))throw Error("invalid template strings array");return Co!==void 0?Co.createHTML(r):r}function Kt(u,r,a=u,h){if(r===$t)return r;let c=h!==void 0?a._$Co?.[h]:a._$Cl,_=we(r)?void 0:r._$litDirective$;return c?.constructor!==_&&(c?._$AO?.(!1),_===void 0?c=void 0:(c=new _(u),c._$AT(u,a,h)),h!==void 0?(a._$Co??(a._$Co=[]))[h]=c:a._$Cl=c),c!==void 0&&(r=Kt(u,c._$AS(u,r.values),c,h)),r}var be,Eo,Je,Co,Zo,St,Bo,Kr,Bt,xe,we,Gi,Yr,Fi,ye,zo,Mo,It,Ao,Oo,$o,Ki,et,pa,_a,$t,N,Io,Zt,Jr,Le,Wi,Pe,Yt,Ui,qi,Vi,ji,Xr,No,Xe=q(()=>{/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */be=globalThis,Eo=u=>u,Je=be.trustedTypes,Co=Je?Je.createPolicy("lit-html",{createHTML:u=>u}):void 0,Zo="$lit$",St=`lit$${Math.random().toFixed(9).slice(2)}$`,Bo="?"+St,Kr=`<${Bo}>`,Bt=document,xe=()=>Bt.createComment(""),we=u=>u===null||typeof u!="object"&&typeof u!="function",Gi=Array.isArray,Yr=u=>Gi(u)||typeof u?.[Symbol.iterator]=="function",Fi=`[ 	
\f\r]`,ye=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,zo=/-->/g,Mo=/>/g,It=RegExp(`>|${Fi}(?:([^\\s"'>=/]+)(${Fi}*=${Fi}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ao=/'/g,Oo=/"/g,$o=/^(?:script|style|textarea|title)$/i,Ki=u=>(r,...a)=>({_$litType$:u,strings:r,values:a}),et=Ki(1),pa=Ki(2),_a=Ki(3),$t=Symbol.for("lit-noChange"),N=Symbol.for("lit-nothing"),Io=new WeakMap,Zt=Bt.createTreeWalker(Bt,129);Jr=(u,r)=>{let a=u.length-1,h=[],c,_=r===2?"<svg>":r===3?"<math>":"",p=ye;for(let v=0;v<a;v++){let y=u[v],P,O,I=-1,j=0;for(;j<y.length&&(p.lastIndex=j,O=p.exec(y),O!==null);)j=p.lastIndex,p===ye?O[1]==="!--"?p=zo:O[1]!==void 0?p=Mo:O[2]!==void 0?($o.test(O[2])&&(c=RegExp("</"+O[2],"g")),p=It):O[3]!==void 0&&(p=It):p===It?O[0]===">"?(p=c??ye,I=-1):O[1]===void 0?I=-2:(I=p.lastIndex-O[2].length,P=O[1],p=O[3]===void 0?It:O[3]==='"'?Oo:Ao):p===Oo||p===Ao?p=It:p===zo||p===Mo?p=ye:(p=It,c=void 0);let M=p===It&&u[v+1].startsWith("/>")?" ":"";_+=p===ye?y+Kr:I>=0?(h.push(P),y.slice(0,I)+Zo+y.slice(I)+St+M):y+St+(I===-2?v:M)}return[Ro(u,_+(u[a]||"<?>")+(r===2?"</svg>":r===3?"</math>":"")),h]},Le=class u{constructor({strings:r,_$litType$:a},h){let c;this.parts=[];let _=0,p=0,v=r.length-1,y=this.parts,[P,O]=Jr(r,a);if(this.el=u.createElement(P,h),Zt.currentNode=this.el.content,a===2||a===3){let I=this.el.content.firstChild;I.replaceWith(...I.childNodes)}for(;(c=Zt.nextNode())!==null&&y.length<v;){if(c.nodeType===1){if(c.hasAttributes())for(let I of c.getAttributeNames())if(I.endsWith(Zo)){let j=O[p++],M=c.getAttribute(I).split(St),Et=/([.?@])?(.*)/.exec(j);y.push({type:1,index:_,name:Et[2],strings:M,ctor:Et[1]==="."?Ui:Et[1]==="?"?qi:Et[1]==="@"?Vi:Yt}),c.removeAttribute(I)}else I.startsWith(St)&&(y.push({type:6,index:_}),c.removeAttribute(I));if($o.test(c.tagName)){let I=c.textContent.split(St),j=I.length-1;if(j>0){c.textContent=Je?Je.emptyScript:"";for(let M=0;M<j;M++)c.append(I[M],xe()),Zt.nextNode(),y.push({type:2,index:++_});c.append(I[j],xe())}}}else if(c.nodeType===8)if(c.data===Bo)y.push({type:2,index:_});else{let I=-1;for(;(I=c.data.indexOf(St,I+1))!==-1;)y.push({type:7,index:_}),I+=St.length-1}_++}}static createElement(r,a){let h=Bt.createElement("template");return h.innerHTML=r,h}};Wi=class{constructor(r,a){this._$AV=[],this._$AN=void 0,this._$AD=r,this._$AM=a}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(r){let{el:{content:a},parts:h}=this._$AD,c=(r?.creationScope??Bt).importNode(a,!0);Zt.currentNode=c;let _=Zt.nextNode(),p=0,v=0,y=h[0];for(;y!==void 0;){if(p===y.index){let P;y.type===2?P=new Pe(_,_.nextSibling,this,r):y.type===1?P=new y.ctor(_,y.name,y.strings,this,r):y.type===6&&(P=new ji(_,this,r)),this._$AV.push(P),y=h[++v]}p!==y?.index&&(_=Zt.nextNode(),p++)}return Zt.currentNode=Bt,c}p(r){let a=0;for(let h of this._$AV)h!==void 0&&(h.strings!==void 0?(h._$AI(r,h,a),a+=h.strings.length-2):h._$AI(r[a])),a++}},Pe=class u{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(r,a,h,c){this.type=2,this._$AH=N,this._$AN=void 0,this._$AA=r,this._$AB=a,this._$AM=h,this.options=c,this._$Cv=c?.isConnected??!0}get parentNode(){let r=this._$AA.parentNode,a=this._$AM;return a!==void 0&&r?.nodeType===11&&(r=a.parentNode),r}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(r,a=this){r=Kt(this,r,a),we(r)?r===N||r==null||r===""?(this._$AH!==N&&this._$AR(),this._$AH=N):r!==this._$AH&&r!==$t&&this._(r):r._$litType$!==void 0?this.$(r):r.nodeType!==void 0?this.T(r):Yr(r)?this.k(r):this._(r)}O(r){return this._$AA.parentNode.insertBefore(r,this._$AB)}T(r){this._$AH!==r&&(this._$AR(),this._$AH=this.O(r))}_(r){this._$AH!==N&&we(this._$AH)?this._$AA.nextSibling.data=r:this.T(Bt.createTextNode(r)),this._$AH=r}$(r){let{values:a,_$litType$:h}=r,c=typeof h=="number"?this._$AC(r):(h.el===void 0&&(h.el=Le.createElement(Ro(h.h,h.h[0]),this.options)),h);if(this._$AH?._$AD===c)this._$AH.p(a);else{let _=new Wi(c,this),p=_.u(this.options);_.p(a),this.T(p),this._$AH=_}}_$AC(r){let a=Io.get(r.strings);return a===void 0&&Io.set(r.strings,a=new Le(r)),a}k(r){Gi(this._$AH)||(this._$AH=[],this._$AR());let a=this._$AH,h,c=0;for(let _ of r)c===a.length?a.push(h=new u(this.O(xe()),this.O(xe()),this,this.options)):h=a[c],h._$AI(_),c++;c<a.length&&(this._$AR(h&&h._$AB.nextSibling,c),a.length=c)}_$AR(r=this._$AA.nextSibling,a){for(this._$AP?.(!1,!0,a);r!==this._$AB;){let h=Eo(r).nextSibling;Eo(r).remove(),r=h}}setConnected(r){this._$AM===void 0&&(this._$Cv=r,this._$AP?.(r))}},Yt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(r,a,h,c,_){this.type=1,this._$AH=N,this._$AN=void 0,this.element=r,this.name=a,this._$AM=c,this.options=_,h.length>2||h[0]!==""||h[1]!==""?(this._$AH=Array(h.length-1).fill(new String),this.strings=h):this._$AH=N}_$AI(r,a=this,h,c){let _=this.strings,p=!1;if(_===void 0)r=Kt(this,r,a,0),p=!we(r)||r!==this._$AH&&r!==$t,p&&(this._$AH=r);else{let v=r,y,P;for(r=_[0],y=0;y<_.length-1;y++)P=Kt(this,v[h+y],a,y),P===$t&&(P=this._$AH[y]),p||(p=!we(P)||P!==this._$AH[y]),P===N?r=N:r!==N&&(r+=(P??"")+_[y+1]),this._$AH[y]=P}p&&!c&&this.j(r)}j(r){r===N?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,r??"")}},Ui=class extends Yt{constructor(){super(...arguments),this.type=3}j(r){this.element[this.name]=r===N?void 0:r}},qi=class extends Yt{constructor(){super(...arguments),this.type=4}j(r){this.element.toggleAttribute(this.name,!!r&&r!==N)}},Vi=class extends Yt{constructor(r,a,h,c,_){super(r,a,h,c,_),this.type=5}_$AI(r,a=this){if((r=Kt(this,r,a,0)??N)===$t)return;let h=this._$AH,c=r===N&&h!==N||r.capture!==h.capture||r.once!==h.once||r.passive!==h.passive,_=r!==N&&(h===N||c);c&&this.element.removeEventListener(this.name,this,h),_&&this.element.addEventListener(this.name,this,r),this._$AH=r}handleEvent(r){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,r):this._$AH.handleEvent(r)}},ji=class{constructor(r,a,h){this.element=r,this.type=6,this._$AN=void 0,this._$AM=a,this.options=h}get _$AU(){return this._$AM._$AU}_$AI(r){Kt(this,r)}},Xr=be.litHtmlPolyfillSupport;Xr?.(Le,Pe),(be.litHtmlVersions??(be.litHtmlVersions=[])).push("3.3.3");No=(u,r,a)=>{let h=a?.renderBefore??r,c=h._$litPart$;if(c===void 0){let _=a?.renderBefore??null;h._$litPart$=c=new Pe(r.insertBefore(xe(),_),_,void 0,a??{})}return c._$AI(u),c}});var Te,pt,Qr,Do=q(()=>{ve();ve();Xe();Xe();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */});var Yi=q(()=>{ve();Xe();Do();Ho()});var Qe,Fo=q(()=>{/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */Qe=u=>(r,a)=>{a!==void 0?a.addInitializer(()=>{customElements.define(u,r)}):customElements.define(u,r)}});function Jt(u){return(r,a)=>typeof a=="object"?ea(u,r,a):((h,c,_)=>{let p=c.hasOwnProperty(_);return c.constructor.createProperty(_,h),p?Object.getOwnPropertyDescriptor(c,_):void 0})(u,r,a)}var ta,ea,Ji=q(()=>{ve();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ta={attribute:!0,type:String,converter:ge,reflect:!1,hasChanged:Ye},ea=(u=ta,r,a)=>{let{kind:h,metadata:c}=a,_=globalThis.litPropertyMetadata.get(c);if(_===void 0&&globalThis.litPropertyMetadata.set(c,_=new Map),h==="setter"&&((u=Object.create(u)).wrapped=!0),_.set(a.name,u),h==="accessor"){let{name:p}=a;return{set(v){let y=r.get.call(this);r.set.call(this,v),this.requestUpdate(p,y,u,!0,v)},init(v){return v!==void 0&&this.C(p,void 0,u,v),v}}}if(h==="setter"){let{name:p}=a;return function(v){let y=this[p];r.call(this,v),this.requestUpdate(p,y,u,!0,v)}}throw Error("Unsupported decorator location: "+h)}});function Xt(u){return Jt({...u,state:!0,attribute:!1})}var Wo=q(()=>{Ji();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */});var Uo=q(()=>{/**
...
`).map(_=>_.trim()).filter(Boolean);this._setEntities(c.map(_=>({entity:_})))}}
    ...
    `}_patch(a){this._emit({...this._config,...a})}_setEntity(a,h){let c=te(this._config.entities??[]);h&&(c[a]={...c[a],entity:h},this._setEntities(c))}_setEntities(a){this._emit({...this._config,entities:a})}_emit(a){this._config=a,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}};ft([Jt({attribute:!1})],kt.prototype,"hass",2),ft([Xt()],kt.prototype,"_config",2),ft([Xt()],kt.prototype,"_pickerReady",2),kt=ft([Qe("mapy-map-card-editor")],kt)});Yi();Xi();var H=Dr(Jo(),1);var Xo=`/* required styles */\r
\r
.leaflet-pane,\r
.leaflet-tile,\r
...
`;async function ts(u,r,a,h){let c=new Date(Date.now()-a*3600*1e3).toISOString(),_=!1,p=await u.connection.subscribeMessage(v=>{!v||!v.states||typeof v.states!="object"||(_=!0,h(Qi(v.states,r)))},{type:"history/stream",start_time:c,end_time:new Date().toISOString(),entity_ids:r},{resubscribe:!0});return setTimeout(()=>{_||p()},1e4),p}function Qi(u,r){let a=[];for(let h of r&&r.length>0?r:Object.keys(u)){let c=u[h];if(Array.isArray(c))for(let _ of c){if(!_||typeof _!="object")continue;let p=_.a??_.attributes??null,v=Number(p?.latitude),y=Number(p?.longitude);a.push({entity_id:h,map_state:Number.isFinite(v)&&Number.isFinite(y)?[v,y]:null})}}return a}nn();var sa={basic:19,outdoor:19,winter:19,aerial:19},ra='&copy; <a href="https://mapy.com/">Mapy.com</a> &copy; <a href="https://www.seznam.cz/">Seznam.cz, a.s.</a>',Nt=class extends pt{constructor(){super(...arguments);this._markers=new Map;this._history=new Map;this._historyStreamDataReceived=!1;this._historyKey="";this._zonesKey="";this._appliedFitKey="";this._onVisibilityChange=()=>{document.visibilityState==="visible"&&(this._map?.invalidateSize({pan:!1}),this._applyFit(),this._healthCheck())};this._onWindowResize=()=>{this._map?.invalidateSize({pan:!1})}}static async getConfigElement(){return await Promise.resolve().then(()=>(on(),ss)),document.createElement("mapy-map-card-editor")}static getStubConfig(a){return{type:"custom:mapy-map-card",entities:a?en(a).slice(0,5):[],hours_to_show:24,show_zones:!0}}setConfig(a){if(!a||typeof a!="object")throw new Error("Invalid configuration");let h=!!a.api_key?.trim()||!!a.tile_url?.trim();this._error=h?void 0:"Missing Mapy.com API key \u2013 set api_key in the card editor (free at developer.mapy.com).",this._config={hours_to_show:24,show_zones:!0,fit_bounds:!0,theme_mode:"auto",tile_style:"basic",aspect_ratio:"16:9",...a},this._resetHistory(),this._map&&(this._updateTileLayer(),this._processHass())}connectedCallback(){super.connectedCallback(),this._config&&!this._error&&!this._map&&this.updateComplete.then(()=>{this.isConnected&&this._config&&!this._map&&!this._error&&(this._initMap(),this._processHass())})}disconnectedCallback(){this._resetHistory(),this._appliedFitKey="",this._pendingFit=void 0,this._resizeObserver?.disconnect(),this._resizeObserver=void 0,document.removeEventListener("visibilitychange",this._onVisibilityChange),window.removeEventListener("resize",this._onWindowResize),this._map?.remove(),this._map=void 0,this._markers.clear(),super.disconnectedCallback()}render(){return this._config?et`
      <style>${Qo}</style>
      <ha-card>
    ...
    `:et``}firstUpdated(){this._error||(this._map||this._initMap(),this._processHass())}willUpdate(a){super.willUpdate(a),a.has("hass")&&this._processHass()}updated(){this._map?.invalidateSize()}_aspectStyle(){let a=this._config?.aspect_ratio?.trim();if(!a||a.toLowerCase()==="auto")return"";let h=/^(\d+(?:\.\d+)?)\s*:\s*(\d+(?:\.\d+)?)$/.exec(a);return h?`aspect-ratio:${h[1]}/${h[2]};`:`height:${a};`}_initMap(){let a=this.renderRoot.querySelector("#map");if(!a)return;this._map=H.map(a,{zoomControl:!0,attributionControl:!1,worldCopyJump:!0}),H.control.attribution({prefix:!1}).addTo(this._map),this._zoneLayer=H.layerGroup().addTo(this._map),this._historyLayer=H.layerGroup().addTo(this._map),this._markerLayer=H.layerGroup().addTo(this._map),this._resizeObserver=new ResizeObserver(()=>{this._map?.invalidateSize(),this._applyFit()}),this._resizeObserver.observe(a),document.addEventListener("visibilitychange",this._onVisibilityChange),window.addEventListener("resize",this._onWindowResize);let h=this.hass?.config,c=typeof h?.latitude=="number"&&typeof h?.longitude=="number"?[h.latitude,h.longitude]:void 0;if(!c)for(let _ of Object.values(this.hass?.states??{})){let p=Rt(_);if(p){c=[p.lat,p.lon];break}}this._map.setView(c??[49.8032,15.4811],this._config?.default_zoom??12,{animate:!1}),this._updateTileLayer();for(let _ of[300,1e3,3e3,8e3])setTimeout(()=>this._healthCheck(),_)}_healthCheck(){if(!(!this._map||!this.isConnected))try{let a=this._map.getContainer();if(!a.clientWidth||!a.clientHeight)return;a.querySelectorAll("img.leaflet-tile").length===0&&(this._map.invalidateSize({pan:!1}),this._applyFit());let h=Array.from(this._markers.values()).some(_=>!!_.getIcon()),c=a.querySelectorAll(".leaflet-marker-pane .mmc-dot, .leaflet-marker-pane .mmc-picture-icon");h&&c.length<this._markers.size&&this._processHass()}catch{}}_updateTileLayer(){if(!this._map||!this._config)return;let a=this._config,h=a.api_key?.trim(),c=a.tile_style??"basic",_=a.tile_url?.trim()||`https://api.mapy.com/v1/maptiles/${c}/256/{z}/{x}/{y}?apikey=${encodeURIComponent(h)}`+(a.language?.trim()?`&lang=${encodeURIComponent(a.language.trim())}`:"");_!==this._tileUrl&&(this._tileUrl=_,this._tileLayer&&this._map.removeLayer(this._tileLayer),this._tileLayer=H.tileLayer(_,{attribution:a.tile_attribution??ra,maxZoom:21,maxNativeZoom:a.tile_url?19:sa[c]??19}),this._tileLayer.addTo(this._map))}_processHass(){!this._map||!this.hass||!this._config||this._error||(this._updateDarkMode(),this._updateZones(),this._updateMarkers(),this._updateHistorySubscription(),this._maybeFitBounds())}_resolvedEntities(){let a=this.hass;return(this._config.entities?.length?te(this._config.entities):en(a).map(c=>({entity:c}))).filter(c=>!!a.states[c.entity])}_updateDarkMode(){let a=ns(this.hass,this._config.theme_mode);this._map.getContainer().classList.toggle("mmc-dark",a)}_updateMarkers(){let a=this._markerLayer,h=new Set;this._resolvedEntities().forEach((c,_)=>{let p=this.hass.states[c.entity],v=Rt(p);if(!v)return;h.add(c.entity);let y=this._markers.get(c.entity);y?y.setLatLng([v.lat,v.lon]):(y=H.marker([v.lat,v.lon],{icon:this._buildIcon(c,p,tn(_)),keyboard:!1}),y.on("click",()=>this._openMoreInfo(c.entity)),y.bindTooltip(is(c,p),{permanent:!0,direction:"right",offset:[12,0],className:"mmc-label"}),y.addTo(a),this._markers.set(c.entity,y))});for(let[c,_]of this._markers)h.has(c)||(a.removeLayer(_),_.remove(),this._markers.delete(c))}_buildIcon(a,h,c){let _=a.picture||h.attributes?.entity_picture;return _&&typeof _=="string"?H.divIcon({className:"mmc-icon-wrapper",html:`<img class="mmc-picture-icon" src="${encodeURI(_)}" alt="">`,iconSize:[40,40],iconAnchor:[20,20]}):H.divIcon({className:"mmc-icon-wrapper",html:`<span class="mmc-dot" style="background:${c}"></span>`,iconSize:[16,16],iconAnchor:[8,8]})}_openMoreInfo(a){let h=new Event("hass-more-info",{bubbles:!0,composed:!0});h.detail={entityId:a},this.dispatchEvent(h)}_updateZones(){let a=Object.values(this.hass.states).filter(p=>p.entity_id.startsWith("zone.")&&Rt(p)),h=JSON.stringify(a.map(p=>[p.entity_id,p.state,p.attributes]));if(h===this._zonesKey)return;this._zonesKey=h;let c=this._zoneLayer;if(c.clearLayers(),this._config.show_zones===!1)return;let _=getComputedStyle(this).getPropertyValue("--accent-color").trim()||"#ff9800";for(let p of a){let v=Rt(p),y=Math.max(0,Number(p.attributes.radius??100)),O=!!p.attributes.passive?"#9e9e9e":_,I=String(p.attributes.friendly_name??p.entity_id);H.circle([v.lat,v.lon],{radius:y,color:O,weight:1,fillColor:O,fillOpacity:.1}).bindTooltip(I,{permanent:!0,direction:"center",className:"mmc-label"}).addTo(c)}}_resetHistory(){this._teardownHistory(),this._historyFallbackTimer!==void 0&&(clearTimeout(this._historyFallbackTimer),this._historyFallbackTimer=void 0),this._historyStreamDataReceived=!1,this._history=new Map,this._historyKey="",this._historyLayer?.clearLayers()}_teardownHistory(){this._unsubHistory&&(this._unsubHistory.then(a=>a()).catch(()=>{}),this._unsubHistory=void 0)}_updateHistorySubscription(){let a=Number(this._config.hours_to_show??24),h=this._resolvedEntities().map(_=>_.entity).sort();if(!(a>0)||h.length===0){this._historyKey&&this._resetHistory();return}let c=`${a}|${h.join(",")}`;c!==this._historyKey&&(this._resetHistory(),this._historyKey=c,this._unsubHistory=ts(this.hass,h,a,_=>{this._onHistoryLocations(_),this._historyStreamDataReceived=!0}).catch(()=>(this._unsubHistory=void 0,this._fetchHistoryFallback(h,a),()=>{})),this._historyFallbackTimer||(this._historyFallbackTimer=setTimeout(()=>{this._historyFallbackTimer=void 0,!this._historyStreamDataReceived&&this.isConnected&&this._fetchHistoryFallback(h,a)},8e3)))}_fetchHistoryFallback(a,h){try{let c=this.hass?.connection;if(!c)return;let _=new Date(Date.now()-h*3600*1e3).toISOString();c.sendMessagePromise({type:"history/history_during_period",start_time:_,end_time:new Date().toISOString(),entity_ids:a,minimal_response:!0,significant_changes_only:!0}).then(p=>{let v=Qi(p,a);v.length>0&&(this._onHistoryLocations(v),this._historyStreamDataReceived=!0)}).catch(()=>{})}catch{}}_onHistoryLocations(a){for(let h of a){if(!h.map_state||h.map_state.length<2)continue;let[c,_]=h.map_state;if(!Number.isFinite(c)||!Number.isFinite(_))continue;let p=this._history.get(h.entity_id)??[],v=p[p.length-1];(!v||v[0]!==c||v[1]!==_)&&(p.push([c,_]),p.length>3e3&&p.splice(0,p.length-3e3),this._history.set(h.entity_id,p))}this._renderHistory()}_renderHistory(){let a=this._historyLayer;a.clearLayers(),this._resolvedEntities().forEach((h,c)=>{let _=this._history.get(h.entity);!_||_.length<2||H.polyline(_,{color:tn(c),weight:4,opacity:.65,interactive:!1}).addTo(a)})}_maybeFitBounds(){if(!this._config.fit_bounds)return;let a=[],h=[];if(this._markers.forEach((_,p)=>{let v=_.getLatLng();a.push([v.lat,v.lng]),h.push(p)}),Object.keys(this.hass.states).filter(_=>_.startsWith("zone.")&&this._config.show_zones!==!1).forEach(_=>{let p=Rt(this.hass.states[_]);p&&(a.push([p.lat,p.lon]),h.push(_))}),a.length===0)return;let c=h.sort().join(",");c===this._appliedFitKey||c===this._pendingFit?.key||(this._pendingFit={key:c,bounds:H.latLngBounds(a)},this._applyFit())}_applyFit(){if(!this._map||!this._pendingFit)return;let a=this._map.getContainer();if(!a.clientWidth||!a.clientHeight)return;let{key:h,bounds:c}=this._pendingFit;if(this._pendingFit=void 0,h===this._appliedFitKey)return;this._appliedFitKey=h;let _=this._config.default_zoom??19,p=c.getCenter(),v=c.getNorthEast(),y=c.getSouthWest();v.distanceTo(y)<50?this._map.setView(p,_):this._map.fitBounds(c,{padding:[48,48],maxZoom:_})}};ft([Jt({attribute:!1})],Nt.prototype,"hass",2),ft([Xt()],Nt.prototype,"_config",2),ft([Xt()],Nt.prototype,"_error",2),Nt=ft([Qe("mapy-map-card")],Nt);on();var aa="mapy-map-card";window.customCards=window.customCards??[];window.customCards.push({type:aa,name:"Mapy.com Map Card",description:"Map card powered by Mapy.com tiles \u2013 entities, history trails, zones. Replacement for the built-in map card.",preview:!0});console.info("%c MAPY-MAP-CARD %c v0.2.2 ","color: white; background: #c83737; font-weight: 700;","color: white; background: #333; font-weight: 700;",`
